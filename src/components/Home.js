  ...
  return (
    <div name="home" className="w-full h-screen bg-[#0a192f]">
        ...
        <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
            ...
            <h2 className="text-4xl sm:text-7xl font-bold text-fuchsia-400">I'm a Fullstack Developer</h2>
            <p className="text-fuchsia-400 py-4 max-w-[700px]">I'm a Medior Fullstack Developer specializing in building web pages. 
